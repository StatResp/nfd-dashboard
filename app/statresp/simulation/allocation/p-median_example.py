...
allocation = allocator.solve(number_of_resources_to_place=num_ambulances,
...
fig=All_seg_incident_4326.plot(All_seg_incident_4326[metadata['unit_name']])
Grid_center[Grid_center['Grid_ID'].isin(allocation)].plot(ax=fig)

All_seg_incident_4326=gpd.GeoDataFrame(All_seg_incident, geometry=All_seg_incident['line'], crs={'init': 'epsg:4326'} )
All_seg_incident_4326.plot(All_seg_incident_4326[metadata['unit_name']])



print('creating grids is done. ')
